...
const Glasses: FC<IProps> = ({ index, glasses }) => {
    return (
        <Container>
            ...
            <Image placeholder="blur" blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mMMqAcAASUA0UwVlscAAAAASUVORK5CYII=" fill src={glasses.image} alt={glasses.description}/>
        </Container>
    )
}
